...
if (daypar>33600) daypar <<- 33600
  if (ifflag==0) {
    ...
    x <<- read.table("C:\\Documents and Settings\\All Users\\Documents\\Paired Files\\Paper and Models For Paired\\New submission\\data P&A no final.dat",nrows=45)
        for (m in 1:9) {
            for (n in 1:5) {
                naq[m,n] <<- x[m*5-5+n,1]
                t2[m,n] <<- x[m*5-5+n,2]
    ...
    x <<- read.table("C:\\Documents and Settings\\All Users\\Documents\\Paired Files\\Paper and Models For Paired\\New submission\\data P&A no final.dat",skip=45, nrows=4)
    ...
    x <<- read.table("C:\\Documents and Settings\\All Users\\Documents\\Paired Files\\Paper and Models For Paired\\New submission\\data P&A no final.dat",skip=49, nrows=10)
        for (i in 1:10) {
            nc1[i]<<- x[i,1]
            nc2[i]<<- x[i,2]
        }
    
    x <<- read.table("C:\\Documents and Settings\\All Users\\Documents\\Paired Files\\Paper and Models For Paired\\New submission\\data P&A no final.dat",skip=59, nrows=14)
        for (i in 1:14) {
            nd1[i]<<- x[i,1]
            nd2[i]<<- x[i,2]
            nd3[i]<<- x[i,3]
    ...
    x <<- read.table("C:\\Documents and Settings\\All Users\\Documents\\Paired Files\\Paper and Models For Paired\\New submission\\data P&A no final.dat",skip=73, nrows=15)
        for (i in 1:15) {
            ne1[i]<<- x[i,1]
            ne2[i]<<- x[i,2]
            ne3[i]<<- x[i,3]
