...
@interface PVNMasterViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end

@implementation PVNMasterViewController
...
- (void)viewDidLoad{
    ...
    self.detailViewController = (PVNDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue
    ...
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        NSManagedObject *object = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        PVNDetailViewController *destination = [segue destinationViewController];
...
-(NSFetchedResultsController *)fetchedResultsController{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"TERMENTRY" inManagedObjectContext:self.managedObjectContext];
